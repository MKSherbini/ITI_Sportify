...
export class GamesControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getNewsUsingGET(newsId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<NewsDto>;
    public getNewsUsingGET(newsId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<NewsDto>>;
    public getNewsUsingGET(newsId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<NewsDto>>;
    public getNewsUsingGET(newsId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<NewsDto>(`${this.configuration.basePath}/api/games/news/${encodeURIComponent(String(newsId))}`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
