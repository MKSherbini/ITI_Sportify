...
export const APIS = [BasicErrorControllerService, GamesControllerService, MatchesControllerService, NewsControllerService, PlayerControllerService, ProfileControllerService, PublishTestService, TeamsControllerService];
